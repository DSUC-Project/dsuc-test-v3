...
export const useStore = create<AppState>((set, get) => ({
  ...
  events: readCache<Event[]>("events", PUBLIC_CACHE_TTL_MS) || (EVENTS as any[]),
  bounties: readCache<Bounty[]>("bounties", PUBLIC_CACHE_TTL_MS) || (BOUNTIES as any[]),
  repos: readCache<Repo[]>("repos", PUBLIC_CACHE_TTL_MS) || (REPOS as any[]),
  resources:
    readCache<Resource[]>("resources", PUBLIC_CACHE_TTL_MS) || (RESOURCES as any[]),
  projects: readCache<Project[]>("projects", PUBLIC_CACHE_TTL_MS) || (PROJECTS as any[]),
  financeRequests: [],
  financeHistory:
