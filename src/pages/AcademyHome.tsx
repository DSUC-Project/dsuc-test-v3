...
export function AcademyHome() {
 ...
 <div className="flex items-start justify-between border-b border-border-main pb-6">
 <div>
 ...
 <div className={`flex h-10 w-full sm:h-12 items-center justify-center border border-border-main transition-all ${day.completed ? 'bg-primary text-white' : 'bg-main-bg text-text-muted/30'} ${day.isToday && !day.completed ? 'border-primary border-dashed' : ''}`}>
 ...
 <div className="flex flex-col h-full justify-center items-center text-center p-6 bg-main-bg border border-border-main border-dashed">
 ...
 <div key={index} className="h-64 animate-pulse bg-surface border border-border-main" />
 ))}
 </div>
 ) : error ? (
 ...
 className="group flex flex-col bg-surface border border-border-main relative overflow-hidden transition-all hover:border-primary hover:shadow-[4px_4px_0_0_var(--shadow-brutal-color)] focus:outline-none"
 >
 <div className="absolute top-0 left-0 w-full h-1 bg-main-bg border-b border-border-main">
 <div 
 ...
 <div className="p-6 md:p-8 flex-1 flex flex-col mt-2">
 ...
 <div className="flex items-center justify-between border-t border-border-main pt-4 text-sm font-bold">
 ...
 >
 <div className="flex items-start justify-between gap-4 border-b border-border-main mb-4 pb-4">
 ...
 <div className="flex flex-wrap items-center justify-between border-t border-border-main pt-4">
