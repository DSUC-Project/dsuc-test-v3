  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-16">
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 pb-8 border-b border-dashed border-border-main">
        ...
        />
        <ActionButton variant="primary" className="mt-4 md:mt-0 max-w-xs">
          Add Project
        </ActionButton>
      </div>
        ...
        {[1, 2, 3, 4, 5, 6].map((i) => (
          ...
          >
            ...
            <div className="p-6 flex flex-col flex-1 bg-surface group-hover:bg-main-bg transition-colors">
              ...
              <p className="font-mono text-[10px] uppercase text-text-muted mb-4">
                Infrastructure
              </p>

              <p className="text-sm text-text-muted mb-6 flex-1">
                A comprehensive operating system for managing student
              ...
              <div className="flex items-center justify-between border-t border-dashed border-border-main pt-4">
                ...
                <span className="font-mono text-[10px] font-bold uppercase group-hover:text-primary transition-colors">
                  View App &rarr;
                </span>
              </div>
            </div>
