...
export function AcademyLesson() {
 ...
 if (!lesson || !trackInfo) {
 return (
 <div className="m-8 border border-border-main bg-white py-20 text-center text-sm font-bold uppercase tracking-widest text-gray-500 shadow-sm">
 ...
 <div className="sticky top-24 z-50 flex flex-col gap-4 border border-border-main bg-white p-4 shadow-sm">
 ...
 <div className="relative mx-6 h-6 flex-1 border border-border-main bg-gray-200">
 <div
 className="absolute left-0 top-0 h-full bg-primary text-primary-foreground border border-border-main transition-all duration-500 ease-out"
 style={{ width: `${progressPercentage}%` }}
 />
 </div>

 <div className="flex items-center gap-2 bg-surface text-text-main border border-border-main px-4 py-2 font-mono text-sm font-bold tracking-widest shadow-sm">
 <Trophy className="h-5 w-5 fill-text-main text-text-main" />
 <span className="hidden sm:inline">Chuỗi: </span>
 <span className="text-xl font-heading text-text-main leading-none">{currentUser?.streak || 0}</span>
 </div>
 </div>
 ...
 <span className="bg-white border border-border-main px-3 py-1 shadow-sm">{trackTitle}</span>
 ...
 <div className="relative flex min-h-[60vh] flex-col border border-border-main bg-white p-6 shadow-sm sm:p-10 ">
 {err && (
 <div className="mb-8 flex items-center gap-3 border border-border-main bg-primary text-primary-foreground px-5 py-4 font-mono text-[13px] font-bold uppercase tracking-widest shadow-sm">
 ...
 className="relative overflow-hidden border border-border-main bg-surface p-6 shadow-sm rounded-xl"
 >
 <div className="mb-3 flex items-center gap-3 font-heading text-lg font-bold text-text-main bg-white border border-border-main px-4 py-2 w-fit uppercase tracking-widest">
 <Terminal size={20} className="text-text-main" /> {callout.title || 'Lưu ý'}
 </div>
 <div className="relative z-10 text-base font-bold leading-relaxed text-text-main bg-white/50 p-4 border border-border-main">
 {callout.body}
 </div>
 </div>
 ))}
 ...
 <Code className="h-10 w-10 text-primary" strokeWidth={3} /> CÂU HỎI [{currentStep}/{quiz.length}]
 </h2>
 ...
 let className = 'border border-border-main hover:bg-surface hover:text-text-main bg-white shadow-sm transition-all hover:-translate-y-1 font-bold uppercase tracking-wide';
 if (submitted) {
 if (isChoiceCorrect) {
 className =
 ...
 className = 'bg-gray-200 border border-border-main text-gray-500 cursor-not-allowed font-medium opacity-80';
 }
 } else if (selected) {
 className = 'border border-border-main bg-primary text-primary-foreground shadow-none -translate-y-1 font-bold uppercase tracking-wide';
 }
 ...
 >
 <p className={`mb-3 flex w-fit items-center gap-2 text-sm font-bold uppercase tracking-widest border border-border-main bg-white px-4 py-2 ${correct ? 'text-primary' : 'text-primary'}`}>
 ...
 <div className="mt-auto flex justify-end border border-border-main pt-8 gap-4 flex-col sm:flex-row">
 {currentStep === 0 ? (
 <button
 onClick={() => {
 if (quiz.length > 0) {
...
function CompletionCelebration({
 ...
 <div className="relative mx-auto mb-6 flex w-fit items-center gap-2 bg-white px-4 py-2 text-[10px] font-bold uppercase tracking-widest text-text-main border border-border-main shadow-sm">
 <span className="h-3 w-3 bg-primary text-primary-foreground animate-pulse border border-border-main" />
 ĐÃ MỞ KHÓA TỐT NGHIỆP
 </div>

 <div className="mb-4 inline-block px-3 py-1 text-sm font-bold uppercase tracking-wider text-text-main bg-white border border-border-main shadow-sm">
 ...
 Bạn đã chính thức vượt qua chuyên đề <span className="font-bold text-primary">{graduationLabel}</span> bằng việc hoàn thành bài học cuối cùng{' '}
 <span className="font-bold text-primary">{lessonTitle}</span>. Hãy tiếp tục duy trì thành tích đăng nhập này nhé.
 </p>

 <div className="mx-auto mt-8 w-fit bg-surface text-text-main border border-border-main px-6 py-3 text-xs font-bold uppercase tracking-widest shadow-sm">
