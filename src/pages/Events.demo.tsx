        ...
        {[1, 2, 3].map((i) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <h3 className="font-heading font-bold text-xl md:text-2xl uppercase tracking-tight mb-2 truncate">
                Solana Anchor Best Practices
              </h3>
              <p className="text-text-muted text-sm max-w-2xl">
                Learn how to write secure eDSL code, protect against reentrancy,
                and structure complex state.
              </p>
            </div>
            ...
            <div className="flex flex-col items-start md:items-end gap-4 min-w-[150px] font-mono text-xs uppercase border-t border-dashed border-border-main md:border-t-0 md:border-l md:pt-0 md:pl-6 pt-4 mt-4 md:mt-0">
              <div className="space-y-1">
                <p className="text-text-muted">
                  Time:{" "}
                  <span className="text-text-main font-bold">18:00 ICT</span>
                </p>
                <p className="text-text-muted">
                  Loc:{" "}
              ...
              <div className="font-bold text-primary flex items-center justify-center w-full border border-border-main px-4 py-2 bg-surface hover:bg-main-bg group-hover:border-primary">
                RSVP LuMa &rarr;
              </div>
            </div>
          </SoftBrutalCard>
