...
export const TRACKS: { id: TrackId; title: string; subtitle: string }[] = [
  ...
  },
  {
    ...
    subtitle:
      "Build real apps: Anchor, CPI, compute budget, architecture, debugging, security basics",
  },
  {
    id: "jonin",
    title: "Jonin (Expert)",
    subtitle:
      "Performance, security/auditing mindset, protocol-level understanding, leadership",
  },
];
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Client-server"),
          choice("b", "Peer-to-peer replication"),
          choice("c", "Many independent validators enforcing rules"),
        ],
        correctChoiceId: "a",
        explanation:
          "Client-server has a central authority controlling data and availability.",
      },
      {
        id: "q2",
        prompt: "Why does P2P reduce single points of failure?",
        choices: [
          choice("a", "Replication across many nodes"),
          choice("b", "No cryptography needed"),
          choice("c", "It uses fewer machines"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "RPC is trusted"),
          choice("b", "Private key approved the message"),
          choice("c", "Transaction will succeed"),
        ],
        correctChoiceId: "b",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Transaction order"),
          choice("b", "Wallet UI"),
          choice("c", "Private keys"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Anyone"),
          choice("b", "Only the owner program"),
          choice("c", "Only the RPC"),
        ],
        correctChoiceId: "b",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Inside programs"),
          choice("b", "In accounts"),
          choice("c", "In the wallet UI"),
        ],
        correctChoiceId: "b",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Rust toolchain"),
          choice("b", "Solscan"),
          choice("c", "Wallet adapter"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Vague idea only"),
          choice("b", "Context + goal + constraints + acceptance"),
          choice("c", "Only stack"),
        ],
        correctChoiceId: "b",
        explanation:
          "This reduces hallucination and forces safety constraints.",
      },
    ],
  },
];
    ...
    quiz: [
      {
        id: "q1",
        prompt:
          "Why should invariants be enforced on every instruction (not only init)?",
        choices: [
          choice(
            "a",
            "Because clients can bypass UI and call instructions directly",
          ),
          choice("b", "Because Anchor requires it"),
          choice("c", "Because RPC caches state"),
        ],
        correctChoiceId: "a",
        explanation:
          "Attackers can call instructions with crafted accounts; invariants must hold always.",
      },
      {
        id: "q2",
        prompt: "A good PDA seed scheme is…",
        choices: [
          choice("a", "Random every time"),
          choice("b", "Stable prefixes + deterministic user identifiers"),
          choice("c", "Depends on UI theme"),
        ],
        correctChoiceId: "b",
        explanation:
          "Stability prevents collisions and makes accounts predictable.",
      },
      {
        id: "q3",
        prompt: "What does an ownership check protect against?",
        choices: [
          choice("a", "RPC outages"),
          choice("b", "Writing to attacker-controlled accounts"),
          choice("c", "Low SOL balance"),
        ],
        correctChoiceId: "b",
        explanation:
          "Without ownership checks, a program can be tricked into mutating wrong state.",
      },
      {
        id: "q4",
        ...
        choices: [
          choice("a", "Config PDA"),
          choice("b", "Any random wallet"),
          choice("c", "Instruction data only"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "They cost more rent always"),
          choice("b", "They allow state mutation; must be validated"),
          choice("c", "They disable signatures"),
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Replacing all security checks"),
          choice("b", "Automating validation of PDAs/owners/signers"),
          choice("c", "Reducing fees"),
        ],
        correctChoiceId: "b",
        explanation:
          "Constraints reduce boilerplate but do not remove the need for threat modeling.",
      },
      {
        id: "q7",
        prompt: "A vault PDA is typically used to…",
        choices: [
          choice("a", "Store UI settings"),
          choice("b", "Control escrowed assets via program logic"),
          choice("c", "Act as an RPC proxy"),
        ],
        correctChoiceId: "b",
        explanation:
          "Vaults are controlled by program-derived authority and rules.",
      },
      {
        id: "q8",
        prompt: "What is the best mental model for a Solana program?",
        choices: [
          choice("a", "A shared library invoked with explicit accounts"),
          choice("b", "A background server with memory"),
          choice("c", "A centralized database"),
        ],
        correctChoiceId: "a",
      ...
      callouts: [
        {
          ...
          body: "This is one of the places where an animation is useful (CPI flow + signer authority). We will add it later.",
        },
      ],
    },
    quiz: [
      {
        ...
        prompt: "What is CPI?",
        choices: [
          choice("a", "Cross-Program Invocation"),
          choice("b", "Compute Price Index"),
          choice("c", "Client Program Interface"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "When the program must act as authority for a PDA"),
          choice("b", "Whenever you call RPC"),
          choice("c", "For reading account data"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "RPC throttling"),
          choice("b", "Your program signs for unintended accounts"),
          choice("c", "Too many signatures"),
        ],
        correctChoiceId: "b",
        explanation:
          "If you sign for the wrong PDA/accounts, you can be exploited.",
      },
      {
        id: "q4",
        prompt: "Best practice before CPI?",
        choices: [
          choice("a", "Validate all accounts used by the CPI target"),
          choice("b", "Skip checks because target program checks"),
          choice("c", "Only validate payer"),
        ],
        correctChoiceId: "a",
        explanation:
          "Never assume the called program will protect you from wrong inputs.",
      },
      {
        id: "q5",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Programs can be reused together like Lego"),
          choice("b", "Everything is centralized"),
          choice("c", "No fees"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        id: "q7",
        prompt:
          "If an attacker can choose accounts in your CPI, what can happen?",
        choices: [
          choice("a", "Nothing"),
          choice("b", "Funds/state can be redirected"),
          choice("c", "Blockhash disappears"),
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          choice("a", "No validation"),
          choice("b", "Account validation + correct program ids"),
          choice("c", "Airdrop"),
        ],
        correctChoiceId: "b",
...
`,
      callouts: [
        {
          title: "Animation note",
          body: "Compute budget + tx lifecycle is one of the few places where an animation helps; we’ll add later.",
        },
      ],
    },
    quiz: [
      {
        id: "q1",
        prompt:
          "Why might a transaction fail during congestion even if logic is correct?",
        choices: [
          choice("a", "Blockhash expiration / prioritization"),
          choice("b", "Because signatures become invalid"),
          choice("c", "Because PDAs change"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Account persistence/creation cost"),
          choice("b", "Wallet UI theme"),
          choice("c", "Consensus rules"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Increase compute limit / set priority fee"),
          choice("b", "Generate PDAs"),
          choice("c", "Verify signatures"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Guess"),
          choice("b", "Read logs and identify failure class"),
          choice("c", "Increase UI padding"),
        ],
        correctChoiceId: "b",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Your tx is too old; fetch new blockhash"),
          choice("b", "Your wallet is hacked"),
          choice("c", "RPC is always wrong"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Speed up inclusion during congestion"),
          choice("b", "Change owner of accounts"),
          choice("c", "Remove rent"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Retries + idempotency where possible"),
          choice("b", "No error handling"),
          choice("c", "Only UI validation"),
        ],
        correctChoiceId: "a",
        explanation:
          "Network conditions fluctuate; code should handle retries safely.",
      },
      {
        id: "q8",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "To understand state, authority, and write locks"),
          choice("b", "To pick fonts"),
          choice("c", "To avoid signatures"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Which accounts are writable and why"),
          choice("b", "Which emoji to use"),
          choice("c", "Which RPC is coolest"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Real constraints and patterns"),
          choice("b", "How to skip testing"),
          choice("c", "How to avoid docs"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "They define who can change what state"),
          choice("b", "They define UI layout"),
          choice("c", "They define seed length"),
        ],
        correctChoiceId: "a",
        explanation:
          "Authority and write-access live in account relationships.",
      },
      {
        id: "q5",
        prompt: "In integrations, a frequent bug class is…",
        choices: [
          choice("a", "Account substitution / wrong account passed"),
          choice("b", "Too many headings"),
          choice("c", "Wrong background color"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Writable account flag"),
          choice("b", "A PNG"),
          choice("c", "A token name"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Owners and authorities"),
          choice("b", "Only colors"),
          choice("c", "Only titles"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "A concrete account graph diagram"),
          choice("b", "A tweet"),
          choice("c", "A new private key"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Validated state transitions and ownership rules"),
          choice("b", "UI preferences"),
          choice("c", "RPC cache"),
        ],
        correctChoiceId: "a",
        explanation:
          "On-chain is for verifiable state transitions and authority.",
      },
      {
        id: "q2",
        prompt: "Why do off-chain indexers exist?",
        choices: [
          choice("a", "To make query UX fast and developer-friendly"),
          choice("b", "To replace consensus"),
          choice("c", "To store private keys"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Double execution of non-idempotent actions"),
          choice("b", "Logging"),
          choice("c", "Using TypeScript"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Things that require trustless verification"),
          choice("b", "Everything"),
          choice("c", "Only CSS"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Reproduce and inspect logs to classify failure"),
          choice("b", "Ignore"),
          choice("c", "Change theme"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Clear error messages + next action"),
          choice("b", "Only “failed”"),
          choice("c", "Nothing"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Repeated requests don’t cause repeated side effects"),
          choice("b", "It removes fees"),
          choice("c", "It avoids signatures"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Components + data flow + trust boundaries"),
          choice("b", "Only logos"),
          choice("c", "Only colors"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Attackers can call instructions directly"),
          choice("b", "Because UI is slow"),
          choice("c", "Because wallets are centralized"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Authority + invariants"),
          choice("b", "Fonts"),
          choice("c", "RPC branding"),
        ],
        correctChoiceId: "a",
        explanation:
          "Most exploits come from missing checks and invariant failures.",
      },
      {
        id: "q3",
        prompt: "A minimal failing case helps because…",
        choices: [
          choice("a", "It isolates root cause quickly"),
          choice("b", "It increases compute"),
          choice("c", "It changes seeds"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Identify failing instruction and error reason"),
          choice("b", "Choose colors"),
          choice("c", "Avoid signatures"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Account substitution (wrong accounts passed)"),
          choice("b", "Too many quizzes"),
          choice("c", "Long markdown"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice(
            "a",
            "Classify failure: signer/ownership/PDA/budget/blockhash",
          ),
          choice("b", "Refactor UI"),
          choice("c", "Redeploy"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Ownership check"),
          choice("b", "Airdrop"),
          choice("c", "Compute budget"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "It fails closed when inputs are wrong"),
          choice("b", "It ignores checks"),
          choice("c", "It hides errors"),
        ],
        correctChoiceId: "a",
...
`,
      callouts: [
        {
          title: "Animation",
          body: "Parallelism and write locks is one of the few places where animation is useful. We can add later.",
        },
      ],
    },
    quiz: [
      {
        ...
        choices: [
          choice("a", "They force serialization due to write locks"),
          choice("b", "They remove signatures"),
          choice("c", "They increase font size"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Sharding/splitting state"),
          choice("b", "Adding more bold text"),
          choice("c", "Using more RPCs"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Writability overlap"),
          choice("b", "Wallet brand"),
          choice("c", "Domain name"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "A parallel computer with explicit locks"),
          choice("b", "A single-threaded app always"),
          choice("c", "A spreadsheet"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Minimize shared writable accounts"),
          choice("b", "Maximize shared writable accounts"),
          choice("c", "Avoid PDAs"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "It determines contention and lock scope"),
          choice("b", "It determines UI color"),
          choice("c", "It determines blockhash"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "The client and inputs"),
          choice("b", "Validator private keys"),
          choice("c", "Your program binary"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice(
            "a",
            "Never trust client-provided accounts without validation",
          ),
          choice("b", "Always use gradients"),
          choice("c", "Always sign every step"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Signing for the wrong accounts/authority"),
          choice("b", "Wrong font choice"),
          choice("c", "Too many headings"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "On every relevant instruction"),
          choice("b", "Only on init"),
          choice("c", "Only in UI"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice(
            "a",
            "Your program writes only to expected program-owned state",
          ),
          choice("b", "RPC is fast"),
          choice("c", "Fees are 0"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "CPI flows and signer authority"),
          choice("b", "Only UI copy"),
          choice("c", "Only README"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Reading specs + tracing real transactions"),
          choice("b", "Only copying code"),
          choice("c", "Only watching price"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Measure bottlenecks and validate optimizations"),
          choice("b", "Avoid logs"),
          choice("c", "Skip tests"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Accounts + instructions + logs"),
          choice("b", "Only UI"),
          choice("c", "Only token name"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Many apps depend on them; they define core behavior"),
          choice("b", "They set website colors"),
          choice("c", "They remove fees"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Risky; you may optimize the wrong thing"),
          choice("b", "Always correct"),
          choice("c", "Free"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Tradeoffs and constraints"),
          choice("b", "No tradeoffs"),
          choice("c", "Only UI"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Infra/RPC related"),
          choice("b", "Font related"),
          choice("c", "Always consensus failures"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Backoff and idempotency awareness"),
          choice("b", "Infinite tight loops"),
          choice("c", "No logging"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Stop hammering a failing dependency"),
          choice("b", "Increase compute"),
          choice("c", "Derive PDAs"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Logs, metrics, traces that explain behavior"),
          choice("b", "More animations"),
          choice("c", "More wallets"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Too few RPC providers"),
          choice("b", "Too many accounts"),
          choice("c", "Too much markdown"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Classify error class"),
          choice("b", "Change UI"),
          choice("c", "Blame users"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Authority boundaries and CPI"),
          choice("b", "Typography"),
          choice("c", "NFT art"),
        ],
        correctChoiceId: "a",
        explanation:
          "Authority misuse and CPI account substitution are common exploit paths.",
      },
      {
        id: "q2",
        prompt: "Before doing a CPI, you should always validate…",
        choices: [
          choice("a", "Target program id and all accounts passed"),
          choice("b", "Only the payer"),
          choice("c", "Only the UI input"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "You sign for an unintended PDA"),
          choice("b", "You add markdown"),
          choice("c", "You use devnet"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Invariants + writable accounts"),
          choice("b", "Only performance"),
          choice("c", "Only design"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Attacker supplies different accounts than intended"),
          choice("b", "Changing fonts"),
          choice("c", "RPC switching"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice(
            "a",
            "A statement that must always be true after instruction execution",
          ),
          choice("b", "A UI tooltip"),
          choice("c", "A gradient"),
        ],
        correctChoiceId: "a",
    ...
    quiz: [
      {
        ...
        choices: [
          choice("a", "Mentoring and setting quality bars"),
          choice("b", "Only shipping features"),
          choice("c", "Only redesigning UI"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Blameless and action-oriented"),
          choice("b", "Only blaming"),
          choice("c", "Hidden from the team"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "They reduce repeated classes of bugs"),
          choice("b", "They increase fees"),
          choice("c", "They replace testing"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "It scales knowledge and reduces bottlenecks"),
          choice("b", "It removes the need for docs"),
          choice("c", "It changes blockhash"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Security, testing, UX, and reliability expectations"),
          choice("b", "Only performance"),
          choice("c", "Only design"),
        ],
        correctChoiceId: "a",
      ...
      },
      {
        ...
        choices: [
          choice("a", "Docs, reviews, workshops, and reusable checklists"),
          choice("b", "Keeping knowledge private"),
          choice("c", "Only tweets"),
        ],
        correctChoiceId: "a",
