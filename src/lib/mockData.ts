...
export const mockEvents = [
  {
    ...
    date: "2026-05-15",
    description:
      "Hands-on workshop preparing teams for the Colosseum Frontier Hackathon. Covers Anchor setup, program deployment, and team coordination.",
    type: "Workshop",
  ...
  },
  {
    ...
    date: "2026-05-22",
    description:
      "Monthly gathering for all DSUC members. Share project updates, celebrate wins, discuss next steps.",
    type: "Meetup",
  ...
  },
  {
    ...
    date: "2026-04-10",
    description:
      "Advanced session covering Anchor macros, PDA patterns, CPI, and program security.",
    type: "Workshop",
    location: "ĐH Đà Nẵng",
    lumaLink: "https://lu.ma",
    status: "past",
...
export const mockProjects = [
  {
    ...
    category: "Tool",
    description:
      "Voice-first AI agent desktop app built with Tauri + React + Agora Web SDK. Targets non-technical users.",
    github: "https://github.com/DSUC-Project",
    demo: "",
    status: "active",
  ...
  },
  {
    ...
    category: "Web3",
    description:
      "Startup idea feedback platform with Solana tipping and MetaDAO futarchy integration.",
    github: "https://github.com/DSUC-Project",
  ...
  },
  {
    ...
    category: "NFT",
    description:
      "Streaming crypto game built for the Colosseum hackathon. NFT-based character system.",
    github: "https://github.com/DSUC-Project",
    demo: "",
    status: "archived",
  ...
  },
  {
    ...
    category: "Tool",
    description:
      "The operating system for DSUC — member management, academy, events, and finance in one platform.",
...
export const mockResources = [
  {
    ...
    tags: ["Anchor", "Rust"],
    description: "Official Anchor framework documentation.",
  },
  {
    id: "r2",
    ...
    tags: ["Solana"],
    description: "Practical Solana development reference.",
  },
  {
    id: "r3",
    title: "Metaplex Docs",
    ...
    tags: ["NFT", "Solana"],
    description: "NFT standard and tooling docs.",
  },
  {
    id: "r4",
    title: "DSUC GitHub",
    ...
    tags: ["Open Source"],
    description: "All DSUC open source projects.",
  },
  {
    id: "r5",
    ...
    tags: ["Solana"],
    description: "Official Solana developer portal.",
  },
  {
    id: "r6",
    ...
    tags: ["Bounties", "Solana"],
    description: "Bounties and grants for Solana ecosystem.",
  },
];
...
export const mockBounties = [
  {
    id: "b1",
    title: "Build a token swap UI component",
    reward: "0.5 SOL",
    difficulty: "Medium",
    ...
    status: "open",
    description:
      "Build a reusable React component for token swapping using Jupiter aggregator.",
  },
  {
    id: "b2",
    title: "Write Anchor tests for lending protocol",
    reward: "1 SOL",
    difficulty: "Hard",
    skills: ["Rust", "Anchor"],
    github: "https://github.com/DSUC-Project",
  ...
  {
    id: "b3",
    title: "Design DSUC merch collection",
    reward: "0.2 SOL",
    difficulty: "Easy",
    skills: ["Design", "Figma"],
    github: "",
...
export const mockFinance = [
  {
    id: "f1",
    type: "Thu" as const,
    description: "Phí thành viên Q1 2026",
    amount: 5000000,
  ...
  },
  {
    id: "f2",
    type: "Chi" as const,
    description: "Thuê phòng workshop tháng 4",
    amount: 2000000,
    status: "approved" as const,
    createdBy: "Zah (Dev)",
    date: "2026-04-10",
  },
  {
    id: "f3",
    type: "Chi" as const,
    description: "In ấn banner sự kiện tháng 5",
    amount: 500000,
  ...
  },
  {
    id: "f4",
    type: "Thu" as const,
    description: "Tài trợ Superteam Q2",
    amount: 10000000,
    status: "approved" as const,
    createdBy: "Nguyễn Văn An",
    date: "2026-04-01",
