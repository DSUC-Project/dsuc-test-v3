    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="relative flex-1 overflow-y-auto p-8 ">
          <button
            onClick={handleClose}
            className="absolute right-5 top-5 border-2 border-transparent p-2 text-text-main transition-colors hover:border-text-main hover:bg-accent"
          >
            <X size={20} />
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full border-4 border-text-main bg-white px-4 py-3 text-sm font-bold text-text-main outline-none transition-colors focus:bg-accent/20"
                required
                minLength={2}
                maxLength={100}
              />
            ...
            <div className="relative space-y-2">
              ...
              <textarea
                ...
                className="h-40 w-full resize-none border-4 border-text-main bg-white px-4 py-3 pr-16 text-sm font-bold text-text-main outline-none transition-colors focus:bg-accent/20"
                required
                minLength={10}
                maxLength={2000}
              />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex min-h-14 w-full items-center justify-center gap-3 border-4 border-text-main bg-accent px-6 py-4 text-sm font-black uppercase tracking-widest text-text-main shadow-md transition-all hover:-translate-y-1 hover:bg-primary hover:text-white hover:shadow-lg disabled:opacity-50"
            >
              <Send size={16} />
